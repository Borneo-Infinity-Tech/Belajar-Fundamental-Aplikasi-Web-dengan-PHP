...
1.  Konsep Client-Server dan HTTP
2.  Struktur Folder Aplikasi Web
3.  Routing dan URL
4.  Alur Kerja PHP di Web Server
...
1.  Pengenalan Konsep Model-View-Controller
2.  Membuat Struktur MVC
3.  Pemisahan Logika, Tampilan dan Data
4.  Studi Kasus: Mini Framework PHP Sederhana

## Keamanan dan Optimasi

1.  Validasi dan Sanitasi Input
2.  Mencegah XSS dan CSRF
3.  Menangangi Error dan Debugging
